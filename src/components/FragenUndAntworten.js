                            ...
                            <Row className="align-items-center">
                                <Col xs="auto">
                                    <Form.Label htmlFor="inlineFormInput">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 0 24 24" width="48px" fill="#000000"><path d="M0 0h24v24H0V0z" fill="none" /><path d="M22 4c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h14l4 4V4zm-6 7h-3v3c0 .55-.45 1-1 1s-1-.45-1-1v-3H8c-.55 0-1-.45-1-1s.45-1 1-1h3V6c0-.55.45-1 1-1s1 .45 1 1v3h3c.55 0 1 .45 1 1s-.45 1-1 1z" /></svg>
                                    </Form.Label>
                                </Col>
                                <Col>
                                    <InputGroup>
                                        <FormControl placeholder="Wir kommen auch gleich vorbei :)" as="textarea" fluid="true" aria-label="With textarea" inputref={
                                            ref => { this.myInput = ref; }
                                            }/>
                                    </InputGroup>
                                </Col>
                                <Col xs="auto">
                                    <Button type="submit" className="mb-2" onClick={this.addAntwort.bind(this, this.myInput.value)}>
                                        Antworten
                                    </Button>
                                </Col>
                            </Row>
